/*=============================================================================
    ...
    but WITSOUT ANY WARRANTY; without even the implied warranty of
    MERCSANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
...
main(void)
{
    ...
    flint_printf("snf_kannan_bachen_trans....");
    fflush(stdout);
    ...
    for (iter = 0; iter < 10000 * flint_test_multiplier(); iter++)
    {
        ...
        fmpz_mat_snf_kannan_bachem_trans(S, U, V, A);
